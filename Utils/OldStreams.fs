...
//let mutable currentWaveIn: option<WaveInEvent> = None
...
//    downsampler.ToSampleProvider()  // We still return a provider at the same sample rate as the source
...
//            currentEffectProvider.Value
//    else
//        // This section runs if we don't oversample
...
//    currentWaveIn <- Some(new WaveInEvent())
